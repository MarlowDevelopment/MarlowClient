...
import net.mommymarlow.marlowclient.setting.*;
...
public class ModButton {
    ...
    public ModButton(Module module, double x, double y, MarlowClickGui parent) {
        this.module = module;
        this.y = y;
        this.x = x;
        this.parent = parent;
    ...
    public void drawScreen(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        if (module.isEnabled()) {
            ...
            RenderUtils.renderRoundedQuad(matrices, parent.windowX + (float) x + 100 + parent.coordModX, parent.windowY + y - 10, parent.windowX + (float) x + 125 + parent.coordModX, parent.windowY + y + 25, 5, 20, new Color(Theme.redEnable, Theme.greenEnable, Theme.blueEnable, (int) ((toggleAnim.getValue() * 10) / 100f * 255)));

            toggleAnim.setEnd(10);

            RenderUtils.renderRoundedQuad(matrices, parent.windowX + (float) x + 380 + parent.coordModX, parent.windowY + y + 2, parent.windowX + (float) x + 400 + parent.coordModX, parent.windowY + y + 12, 4, 5, new Color(Theme.red1Enable, Theme.green1Enable, Theme.blue1Enable, (int) ((toggleAnim.getValue() * 10) / 100f * 255)));
