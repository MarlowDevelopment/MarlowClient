...
public abstract class Module implements Serializable, Listener {
    ...
    public void toggle() {
       ...
       if(enabled) {
           onEnable();
           mc.player.sendMessage(Text.of(MarlowClient.getCommandPrefix() + " "+ ColorUtils.green+name + "was enabled!"));
       }
       else {
           onDisable();
           mc.player.sendMessage(Text.of(MarlowClient.getCommandPrefix() + " "+ ColorUtils.red+name + "was disabled!"));
       }
    }
