...
public class Config {
    ...
    public Config(String name, String description, File file) {
        ...
        // Main Folder
        ROOT_DIR = new File(FabricLoader.getInstance().getGameDirectory(), Marlow.getName());
    ...
    public Config(String name, String description) {
        ...
        // Main Folder
        ROOT_DIR = new File(FabricLoader.getInstance().getGameDirectory(), Marlow.getINSTANCE().getName());
        if(!ROOT_DIR.exists()) ROOT_DIR.mkdir();
